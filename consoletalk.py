...
class Consoletalk:
    ...
    async def console(self, ctx):
        ...
        if not self.getting_input():
            ...
            if success:
                await self.bot.say("I will now speak for my owner. Owner, please type in my terminal.. be gentle")
                trigger = True
            else:
            ...
            if success:
                ...
                if success == True:
                    ...
                    if success == True:
                        ...
                        await self.bot.say("I was not able to release the console.")
